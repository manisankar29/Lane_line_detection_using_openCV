...
2. Place your input video files in the same directory as the script. In the provided code, the input videos are [challenge_video.mp4](Test_videos/challenge_video.mp4) and [challenge_video1.mp4](Test_videos/challenge_video1.mp4).
